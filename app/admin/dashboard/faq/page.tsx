                ...
                <table className="w-full border-collapse">
                    <thead className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                        <tr >
                            ...
                            <th scope="col" className="px-4 py-[14px] text-left text-[12px] font-semibold text-sky-600  uppercase tracking-wider whitespace-nowrap" >FAQ Details</th>
                        ...
                        {loading ? (
                            ...
                            filteredFaqs.map((faq, index) => (
                                <tr key={index} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <div>
                                            <h4 className="font-bold text-slate-800 text-sm line-clamp-1">{faq.question}</h4>
